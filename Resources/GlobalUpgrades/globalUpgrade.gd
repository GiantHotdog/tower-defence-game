...
enum ValidIds { NULL, XP_GAIN_10_PC_INCREASE, XP_GAIN_20_PC_INCREASE,
				SIGTERM_COOLDOWN_10_PC_DECREASE, SIGTERM_RANGE_15_PC_INCREASE,
				LOGIC_GATE_COOLDOWN_20_PC_DECREASE, LOGIC_GATE_RANGE_10_PC_INCREASE}
enum UpgradeClass { NULL, XP_GAIN, SIGTERM_COOLDOWN, SIGTERM_RANGE,
				LOGIC_GATE_COOLDOWN, LOGIC_GATE_RANGE}
